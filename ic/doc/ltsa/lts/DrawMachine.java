          ...
          if (str.charAt(0) != '@')
            while (eventState1 != null) {
              ...
              if (!this.newLabelFormat) {
                ...
                drawTransition(paramGraphics, b2, eventState1.next, this.labels[b2 + 1][eventState1.next + 1], arrayOfInt[eventState1.next + 1], (b2 == this.lastselected && eventState1.next == this.selected), true);
              } 
              eventState1 = eventState1.nondet;
            }  
          eventState = eventState.list;
