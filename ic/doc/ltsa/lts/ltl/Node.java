...
public class Node implements Comparable {
  ...
  private boolean isRedundant(SortedSet paramSortedSet1, SortedSet paramSortedSet2, Formula paramFormula) {
    return (fac.specialCaseV(paramFormula, paramSortedSet1) || (fac.syntaxImplied(paramFormula, paramSortedSet1, paramSortedSet2) && (!(paramFormula instanceof Until) || fac.syntaxImplied(paramFormula.getSub2(), paramSortedSet1, paramSortedSet2))));
  }
