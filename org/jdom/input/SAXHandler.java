...
public class SAXHandler extends DefaultHandler implements LexicalHandler, DeclHandler, DTDHandler {
  ...
  public void processingInstruction(String target, String data) throws SAXException {
    ...
    if (this.atRoot) {
      ...
      getCurrentElement().addContent(
          this.factory.processingInstruction(target, data));
    } 
  }
  ...
  public void startDTD(String name, String publicID, String systemID) throws SAXException {
    flushCharacters();
    this.document.setDocType(
        this.factory.docType(name, publicID, systemID));
    this.inDTD = true;
    ...
    if (!this.inDTD && !commentText.equals(""))
      if (this.stack.empty()) {
        this.document.addContent(
            this.factory.comment(commentText));
      } else {
        getCurrentElement().addContent(
            this.factory.comment(commentText));
      }  
