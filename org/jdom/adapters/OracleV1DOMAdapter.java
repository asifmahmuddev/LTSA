...
public class OracleV1DOMAdapter extends AbstractDOMAdapter {
  private static final String CVS_ID = "@(#) $RCSfile: OracleV1DOMAdapter.java,v $ $Revision: 1.11 $ $Date: 2002/01/08 09:17:10 $ $Name: jdom_1_0_b8 $";
  ...
  public Document getDocument(InputStream in, boolean validate) throws IOException {
    try {
      ...
      throw new IOException(String.valueOf(e.getClass().getName()) + ": " + 
          e.getMessage());
    } 
  }
