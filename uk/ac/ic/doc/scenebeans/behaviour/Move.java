...
public class Move extends DoubleActivityBase implements Serializable {
  ...
  public Move(double paramDouble1, double paramDouble2, double paramDouble3) {
