...
public class MultiTrack extends PointActivityBase implements Serializable {
  ...
  private Point2D _avoid = new Point2D.Double(0.0D, 0.0D);
  
  public MultiTrack() {
    this._nodes = new double[0];
    this._events = new String[0];
    this._avoid = new Point2D.Double(100000.0D, 100000.0D);
  }
  
  public void setAvoid(Point2D paramPoint2D) {
    this._avoid = paramPoint2D;
  }
  ...
  private boolean isCollision() {
    return (this._avoid.distanceSq(getValue()) < this._spacing * this._spacing);
  }
  
  public class AvoidAdapter implements PointBehaviourListener {
    private final MultiTrack this$0;
    
    public AvoidAdapter(MultiTrack this$0) {
      this.this$0 = this$0;
    }
    
    public void behaviourUpdated(Point2D param1Point2D) {
      this.this$0.setAvoid(param1Point2D);
    }
  }
  
  public final AvoidAdapter newAvoidAdapter() {
    return new AvoidAdapter(this);
  }
}
