...
public class Library {
  ...
  Object getMethod(String paramString, Class[] paramArrayOfClass) throws NoSuchMethodException {
    ...
    while (enumeration2.hasMoreElements()) {
      ...
      if ((bool1 ^ bool2) == 0)
        throw new NoSuchMethodException("Ambiguity detected between \"" + describe(paramString, arrayOfClass) + "\" and \"" + describe(paramString, arrayOfClass1) + "\" on invocation \"" + describe(paramString, paramArrayOfClass) + "\" ."); 
    } 
    return object;
  }
