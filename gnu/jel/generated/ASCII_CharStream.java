...
public final class ASCII_CharStream {
  ...
  public final String GetImage() {
    return (this.bufpos >= this.tokenBegin) ? new String(this.buffer, this.tokenBegin, this.bufpos - this.tokenBegin + 1) : (String.valueOf(new String(this.buffer, this.tokenBegin, this.bufsize - this.tokenBegin)) + new String(this.buffer, 0, this.bufpos + 1));
  }
