...
class OP_load extends OP {
  ...
  public String toString() {
    return this.type.isPrimitive() ? (String.valueOf(this.what.toString()) + typecodes[ExpressionImage.primitiveID(this.type)]) : ((this.what instanceof String) ? ("\"" + this.what + "\"") : this.what.toString());
  }
}
