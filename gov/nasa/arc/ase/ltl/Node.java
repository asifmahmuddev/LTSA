...
class Node implements Comparable {
  ...
  private static boolean is_redundant(TreeSet paramTreeSet1, TreeSet paramTreeSet2, Formula paramFormula) {
    if (paramFormula.is_special_case_of_V(paramTreeSet1) || (paramFormula.is_synt_implied(paramTreeSet1, paramTreeSet2) && (paramFormula.getContent() != 'U' || paramFormula.getSub2().is_synt_implied(paramTreeSet1, paramTreeSet2))))
      return true; 
    return false;
  }
