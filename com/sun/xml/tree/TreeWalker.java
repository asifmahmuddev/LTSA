...
public class TreeWalker {
  ...
  public Node getNext() {
    ...
    switch (this.current.getNodeType()) {
      ...
      case 10:
        node2 = this.current;
        for (; node2 != null && node2 != this.startPoint; 
    ...
    throw new InternalError(((NodeBase)this.startPoint).getMessage("TW-000", 
          new Object[] { Short.toString(this.current
              .getNodeType()) }));
  }
  ...
  public Element getNextElement(String paramString) {
    ...
    for (; node != null; 
      ...
      if (node.getNodeType() == 1 && (
        paramString == null || paramString.equals(node.getNodeName())))
        return (Element)node; 
    } 
    this.current = null;
    return null;
  ...
  public Node removeCurrent() {
    if (this.current == null)
      throw new IllegalStateException(((NodeBase)this.startPoint)
          .getMessage("TW-001")); 
    ...
    for (; node4 != null && node4 != this.startPoint; 
