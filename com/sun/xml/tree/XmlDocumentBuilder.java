...
public class XmlDocumentBuilder implements LexicalEventListener {
  ...
  private String getNamespaceURI(String paramString) {
    ...
    if ("xmlns".equals(paramString))
      return null; 
    return this.elementStack[this.topOfStack]
      .getInheritedAttribute("xmlns:" + paramString);
  }
      ...
      try {
        if (!this.disableNamespaces)
          for (byte b1 = 0; b1 < b; b1++) {
            ...
            if (!"CDATA".equals(str) && 
              !str.startsWith("NMTOKEN"))
              if (paramAttributeList.getValue(b1).indexOf(':') != -1)
                error(new SAXParseException(
                      getMessage("XDB-001", 
                        new Object[] { paramAttributeList.getName(b1) }), this.locator));  
          }  
        attributeSet = new AttributeSet(paramAttributeList);
      } catch (DOMException dOMException) {
        fatal(new SAXParseException(getMessage("XDB-002", 
                new Object[] { dOMException.getMessage() }), this.locator, dOMException));
      }  
    try {
      if (this.disableNamespaces) {
        ...
        if (i != -1) {
          ...
          if (paramString.lastIndexOf(':') != i)
            error(new SAXParseException(getMessage("XDB-003", 
                    new Object[] { paramString }), this.locator)); 
        } 
        if (attributeSet != null)
          str2 = attributeSet.getValue(str1); 
        if ("".equals(str2))
          str2 = this.elementStack[this.topOfStack]
            .getInheritedAttribute(str1); 
        elementNode = (ElementNode)this.document.createElementEx(str2, 
            str3);
        if (str3 != paramString)
          elementNode.setTag(paramString); 
      } 
    } catch (DOMException dOMException) {
      fatal(new SAXParseException(getMessage("XDB-004", 
              new Object[] { dOMException.getMessage() }), this.locator, dOMException));
    } 
    if (paramAttributeList != null && paramAttributeList instanceof AttributeListEx)
      elementNode.setIdAttributeName((
          (AttributeListEx)paramAttributeList).getIdAttributeName()); 
    if (b != 0)
        ...
        for (byte b1 = 0; b1 < b; b1++) {
          ...
          if (i > 0) {
            ...
            if (!"xmlns".equals(str1)) {
              ...
              if (str2 == null) {
                error(new SAXParseException(
                      getMessage("XDB-006", new Object[] { str1 }), this.locator));
              } else {
                if (str.lastIndexOf(':') != i)
                  error(new SAXParseException(
                        getMessage("XDB-007", new Object[] { str }), this.locator)); 
                str = str.substring(i + 1);
                str = String.valueOf(str2) + Character.MAX_VALUE + str;
                if (this.attrTmp.contains(str)) {
                  error(new SAXParseException(
                        getMessage("XDB-008", new Object[] { attributeSet
                            .item(b1).getNodeName() }), this.locator));
                } else {
  ...
  public void processingInstruction(String paramString1, String paramString2) throws SAXException {
    ...
    ParentNode parentNode = this.elementStack[this.topOfStack];
    try {
      PINode pINode = (PINode)this.document.createProcessingInstruction(paramString1, 
          paramString2);
  ...
  public void endParsedEntity(String paramString, boolean paramBoolean) throws SAXException {
    ...
    if (!paramString.equals(parentNode.getNodeName()))
      fatal(new SAXParseException(getMessage("XDB-011", 
              new Object[] { paramString, parentNode.getNodeName() }), this.locator)); 
    try {
  ...
  class DtdListener implements DtdEventListener {
    ...
    public void externalEntityDecl(String param1String1, String param1String2, String param1String3) throws SAXException {
      if (!this.this$0.disableNamespaces && param1String1.indexOf(':') != -1)
        this.this$0.error(new SAXParseException(this.this$0.getMessage("XDB-012"), 
              this.this$0.locator)); 
    ...
    public void notationDecl(String param1String1, String param1String2, String param1String3) throws SAXException {
      if (!this.this$0.disableNamespaces && param1String1.indexOf(':') != -1)
        this.this$0.error(new SAXParseException(this.this$0.getMessage("XDB-013"), 
              this.this$0.locator)); 
    ...
    public void attributeDecl(String param1String1, String param1String2, String param1String3, String[] param1ArrayOfString, String param1String4, boolean param1Boolean1, boolean param1Boolean2) throws SAXException {}
