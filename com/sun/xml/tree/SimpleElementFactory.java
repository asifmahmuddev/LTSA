...
public class SimpleElementFactory implements ElementFactory {
    ...
    if (clazz == null) {
      ...
      try {
        ...
        throw new IllegalArgumentException(getMessage("SEF-003", 
              new Object[] { paramString, clazz.getName(), 
  ...
  public ElementEx createElementEx(String paramString1, String paramString2) {
    ...
    return doMap(paramString2, dictionary, 
        (ClassLoader)this.nsLoaders.get(paramString1));
  }
