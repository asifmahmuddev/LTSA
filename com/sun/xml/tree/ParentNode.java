  ...
  public Node removeChild(Node paramNode) throws DOMException {
    ...
    for (byte b = 0; b < this.length; b++) {
      if (this.children[b] == nodeBase) {
        if (b + 1 != this.length)
          System.arraycopy(this.children, b + 1, this.children, b, 
              this.length - 1 - b); 
        this.length--;
  ...
  class TagList implements NodeList {
    ...
    public Node item(int param1Int) {
      ...
      if (this.lastWalker != null && (
        param1Int < this.lastIndex || i != this.lastMutationCount))
      ...
      while (param1Int > this.lastIndex && (
        element = this.lastWalker.getNextElement(this.tag)) != null)
        this.lastIndex++; 
      return element;
    }
