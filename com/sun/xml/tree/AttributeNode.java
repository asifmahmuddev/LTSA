...
final class AttributeNode extends NodeBase implements Attr, NamespaceScoped {
  ...
  public AttributeNode(AttributeNode paramAttributeNode) throws DOMException {
    this(paramAttributeNode.name, paramAttributeNode.value, 
        paramAttributeNode.specified, paramAttributeNode.defaultValue);
  ...
  void setNameScope(ElementNode paramElementNode) {
    if (paramElementNode != null && this.nameScope != null)
      throw new IllegalStateException(getMessage("A-000", 
            new Object[] { paramElementNode.getTagName() })); 
  ...
  public Node cloneNode(boolean paramBoolean) {
    try {
      AttributeNode attributeNode = new AttributeNode(this.name, this.value, 
