    ...
    switch (this.model.type) {
      ...
      case '+':
        if (this.model.first(paramString)) {
          ...
          if (this.model.content instanceof String)
            return this; 
          return (new ContentModelState(this.model.content, this))
            .advance(paramString);
        } 
      ...
      case '?':
        if (this.model.first(paramString)) {
          if (this.model.content instanceof String)
            return this.next; 
          return (new ContentModelState(this.model.content, this.next))
            .advance(paramString);
        } 
        if (this.next != null)
          return this.next.advance(paramString); 
      ...
      case '|':
        for (contentModel = this.model; contentModel != null; contentModel = contentModel.next) {
          if (contentModel.content instanceof String) {
            ...
            return (new ContentModelState(contentModel.content, this.next))
              .advance(paramString);
          } 
        } 
