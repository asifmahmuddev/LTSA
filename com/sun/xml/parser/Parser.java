...
public class Parser implements Parser {
  ...
  public void setLocale(Locale paramLocale) throws SAXException {
    if (paramLocale != null && !messages.isLocaleSupported(paramLocale.toString()))
      throw new SAXException(messages.getMessage(this.locale, 
            "P-078", new Object[] { paramLocale })); 
  ...
  private void parseInternal(InputSource paramInputSource) throws SAXException, IOException {
    ...
    try {
      ...
      if (!this.in.isEOF())
        fatal("P-001", 
            new Object[] { Integer.toHexString(getc()) }); 
      ...
      if (!this.in.isDocument()) {
        ...
        while (true) {
          ...
          if (!this.in.isInternal()) {
            fatal("P-002", 
                new Object[] { str }, endOfInputException);
            return;
          } 
        } 
      } 
      ...
      throw new SAXParseException(
          ...
          this.locator.getPublicId(), this.locator.getSystemId(), 
  ...
  private void whitespace(String paramString) throws IOException, SAXException {
    if (!maybeWhitespace())
      fatal("P-004", 
          new Object[] { messages.getMessage(this.locale, paramString) }); 
  }
        ...
        if (c1 == '%' && paramBoolean) {
          ...
          if (str != null) {
            ...
            if (this.inExternalPE) {
              expandEntityInLiteral(str, 
                  this.params, paramBoolean);
              continue;
            } 
  ...
  private void expandEntityInLiteral(String paramString, SimpleHashtable paramSimpleHashtable, boolean paramBoolean) throws SAXException, IOException {
    ...
    if (object instanceof InternalEntity) {
      ...
      if (this.isValidating && 
        this.isStandalone && 
        !internalEntity.isFromInternalSubset)
      ...
      fatal(
          (paramSimpleHashtable == this.params) ? "V-022" : "P-014", 
  ...
  private boolean maybeDoctypeDecl() throws IOException, SAXException {
    ...
    if (maybeWhitespace() && (
      externalEntity = maybeExternalID()) != null) {
      this.dtdListener.externalDtdDecl(externalEntity.publicId, 
  ...
  private boolean maybeElement(ElementValidator paramElementValidator) throws IOException, SAXException {
    ...
    if (this.isValidating) {
      ...
      if (paramElementValidator == null && 
        this.rootElementName != null && 
        !this.rootElementName.equals(nameCacheEntry.name))
    ...
    while (!this.in.peekc('>')) {
      ...
      AttributeDecl attributeDecl = (elementDecl == null) ? 
        null : 
        (AttributeDecl)elementDecl.attributes.get(str1);
      if (attributeDecl == null) {
        ...
        if (this.isValidating && 
          attributeDecl.isFixed && 
          !str2.equals(attributeDecl.defaultValue))
          error("V-008", 
              new Object[] { str1, nameCacheEntry.name, attributeDecl.defaultValue }); 
      } 
      if ("xml:lang".equals(str1) && !isXmlLang(str2))
        error("P-033", new Object[] { str2 }); 
      this.attTmp.addAttribute(str1, 
          (attributeDecl == null) ? "CDATA" : attributeDecl.type, 
          str2, (attributeDecl == null) ? null : attributeDecl.defaultValue, 
          true);
      bool1 = true;
    } 
    if (elementDecl != null)
    ...
    if (elementDecl != null && elementDecl.attributes.size() != 0)
      bool1 = (!defaultAttributes(this.attTmp, elementDecl) && 
        !bool1) ? false : true; 
    ...
    if (bool2) {
      ...
      if (!this.in.peek(nameCacheEntry.name, nameCacheEntry.chars))
        fatal("P-034", 
            new Object[] { nameCacheEntry.name, new Integer(i) }); 
      this.in.maybeWhitespace();
    } 
    ...
    while (enumeration.hasMoreElements()) {
      ...
      if (str2 == null) {
        ...
        if (attributeDecl.defaultValue != null) {
          if (this.isValidating && 
            this.isStandalone && !attributeDecl.isFromInternalSubset)
            error("V-010", new Object[] { str1 }); 
          paramAttributeListImpl.addAttribute(str1, attributeDecl.type, 
              attributeDecl.defaultValue, attributeDecl.defaultValue, false);
          bool = true;
        } 
      } 
    } 
  ...
  private void content(ElementDecl paramElementDecl, boolean paramBoolean, ElementValidator paramElementValidator) throws IOException, SAXException {
    while (true) {
      if (this.in.peekc('<'))
        if (!maybeElement(paramElementValidator)) {
          ...
          if (maybeComment(true) || maybePI(true))
            continue; 
          if (!this.in.unparsedContent(this.docHandler, paramElementValidator, !(
              paramElementDecl == null || !paramElementDecl.ignoreWhitespace), 
              (this.isStandalone && 
              this.isValidating && 
              !paramElementDecl.isFromInternalSubset) ? 
              "V-023" : 
              null)) {
            char c = getc();
      ...
      if (paramElementDecl != null && 
        paramElementDecl.ignoreWhitespace && 
        this.in.ignorableWhitespace(this.docHandler)) {
        if (this.isValidating && 
          this.isStandalone && !paramElementDecl.isFromInternalSubset)
  ...
  private void getMixed(String paramString, InputEntity paramInputEntity) throws IOException, SAXException {
    ...
    while (peek("|")) {
      ...
      if (str == null)
        fatal("P-042", 
            new Object[] { paramString, Integer.toHexString(getc()) }); 
      if (this.isValidating)
    ...
    if (!peek(")*"))
      fatal("P-043", 
          new Object[] { paramString, new Character(getc()) }); 
    if (this.isValidating && this.in != paramInputEntity)
      error("V-014", new Object[] { paramString }); 
    this.strTmp.append(')');
  }
  ...
  private String normalize(boolean paramBoolean) throws SAXException {
    ...
    if (this.isValidating && this.isStandalone && 
      paramBoolean && (str2 == null || bool))
      error("V-019", null); 
    if (bool)
      return this.strTmp.toString(); 
    return str1;
  ...
  private boolean maybeReferenceInContent(ElementDecl paramElementDecl, ElementValidator paramElementValidator) throws IOException, SAXException {
    ...
    this.docHandler.characters(this.charTmp, 0, 
  ...
  private void expandEntityInContent(ElementDecl paramElementDecl, String paramString, ElementValidator paramElementValidator) throws SAXException, IOException {
    ...
    if (object instanceof InternalEntity) {
      ...
      if (this.isValidating && 
        this.isStandalone && 
        !externalEntity.isFromInternalSubset)
        error("V-002", new Object[] { paramString }); 
    ...
    if (externalEntity == null) {
      ...
      if (i != 0) {
        ...
        if (simpleHashtable == this.entities && !(this.dtdListener instanceof ListenerBase))
          this.dtdListener.internalEntityDecl(str, 
              new String(arrayOfChar)); 
      } 
    } else {
      if (simpleHashtable == this.entities && maybeWhitespace() && 
        peek("NDATA")) {
        externalEntity.notation = getMarkupDeclname("F-018", false);
        if (this.isValidating && 
          this.notations.get(externalEntity.notation) == null)
      ...
      if (i != 0) {
        ...
        if (externalEntity.notation != null) {
          this.dtdHandler.unparsedEntityDecl(str, 
              externalEntity.publicId, externalEntity.systemId, 
              externalEntity.notation);
        } else if (simpleHashtable == this.entities) {
          this.dtdListener.externalEntityDecl(str, 
              externalEntity.publicId, externalEntity.systemId);
        } 
      } 
    } 
  ...
  private boolean maybeNotationDecl() throws IOException, SAXException {
    ...
    if (object != null && object instanceof ExternalEntity) {
      ...
      this.dtdHandler.notationDecl(str, externalEntity.publicId, 
          externalEntity.systemId);
    } 
    return true;
  }
  ...
  private void nextChar(char paramChar, String paramString1, String paramString2) throws IOException, SAXException {
    ...
    if (!this.in.peekc(paramChar))
      fatal("P-008", 
          new Object[] { new Character(paramChar), 
            messages.getMessage(this.locale, paramString1), 
            (paramString2 == null) ? "" : (String.valueOf('"') + paramString2 + '"') }); 
  }
  ...
  private void warning(String paramString, Object[] paramArrayOfObject) throws SAXException {
    SAXParseException sAXParseException = new SAXParseException(
        messages.getMessage(this.locale, paramString, paramArrayOfObject), 
        this.locator);
